...
def encode(coverFile, payloadFile, choice, lsb):
    #choice:
    ...
    if choice == 1:
        ...
        path = r"C:\Users\chewc\OneDrive\Desktop"
        name =  "encoded_image.png"
        # path = ''.join(path, name)
        path = os.path.join(path, name)
        # os.chmod(path, 777)
        cv2.imwrite(path, cover_img)
        # cv2.imwrite(path, cover_img)
        return path
...
# encode(r"C:\Users\chewc\OneDrive\Desktop\coverImageSIT.png",r"C:\Users\chewc\OneDrive\Desktop\RANDOM.txt",1,5)
